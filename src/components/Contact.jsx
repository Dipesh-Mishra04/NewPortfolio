...
export default function Contact() {
  return (
    <section id="contact" className="relative py-16 px-6 bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white overflow-hidden">
      {/* Title */}
      <motion.h2
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="relative max-w-3xl mx-auto bg-white/10 backdrop-blur-2xl rounded-3xl shadow-[0_0_50px_rgba(200,0,255,0.15)] border border-white/20 p-10 space-y-10"
      >
        {/* Contact Info */}
        <div className="flex justify-between max-w-3xl mx-auto mb-10">
          <motion.div
          ...
          <motion.div
            ...
            className="flex items-center gap-5 mr-8"
          >
            <div className="p-4 bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-600 rounded-2xl shadow-lg">
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-5 max-w-3xl mx-auto"
        >
          <div className="p-4 bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-600 rounded-2xl shadow-lg">
        ...
        {/* Form */}
        <form action="https://formspree.io/f/xrblybqj" method="POST" className="space-y-6">
          <motion.input
        ...
        <div className="flex justify-center gap-8 pt-4">
          {[
            { icon: FaGithub, link: "https://github.com/Dipesh-Mishra04", color: "hover:text-gray-200" },
            { icon: FaLinkedin, link: "https://www.linkedin.com/in/dipesh-mishra-6299b0275/", color: "hover:text-blue-400" },
            { icon: FaInstagram, link: "https://www.instagram.com/mi_sh_ra_ji_77?igsh=NWFua3lxNmJvaTQ2", color: "hover:text-pink-400" }
          ].map((item, i) => (
            <motion.a
              key={i}
              href={item.link}
